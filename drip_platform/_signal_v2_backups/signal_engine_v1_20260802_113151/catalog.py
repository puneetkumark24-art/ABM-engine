...
ACCOUNTS = [
    ...
    {"id": "baj", "name": "Bank AlJazira", "aliases": ["Bank Al Jazira", "BAJ", "بنك الجزيرة"], "domains": ["baj.com.sa"], "tickers": ["1020"]},
...
SOURCES = [
    ...
    },
    {
        ...
        "kind": "rss", "language": "en", "endpoint": google_news_url('(site:alahli.com OR site:alrajhibank.com.sa OR site:riyadbank.com OR site:sab.com OR site:alinma.com OR site:anb.com.sa OR site:baj.com.sa OR site:bankalbilad.com OR site:bsf.sa OR site:stcbank.com.sa OR site:d360bank.com)'),
